...
class QrCodeService:
	...
	async def create(self, represent: str, box_size: int, border: int, image_format: str,
		...
		try:
			...
			# Generate QR code
			_qr = qrcode.QRCode(version=1, box_size=box_size, border=border,
